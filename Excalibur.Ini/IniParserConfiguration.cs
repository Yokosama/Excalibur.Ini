namespace Excalibur.Ini
{
    ...
    {
        /// <summary>
        /// 按名称检索节点/属性关键字时不区分大小写
        /// </summary>
        public bool CaseInsensitive { get; set; } = false;

        /// <summary>
        /// true：允许全局节点存在，无需先定义节点再写属性
        /// </summary>
